...
public class ExamplePuzzles {
	...
	private static final me.tacchino.sudoku.SudokuTable[] exampleTables = new me.tacchino.sudoku.SudokuTable[3];
	...
	public me.tacchino.sudoku.SudokuTable createExamplePuzzle() {
		me.tacchino.sudoku.SudokuTable table = exampleTables[tableNum];
	...
	public ExamplePuzzles() {
		for (int i = 0; i < exampleTables.length; i++) {
			exampleTables[i] = new me.tacchino.sudoku.SudokuTable();
		}
