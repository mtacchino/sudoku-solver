...
public class SudokuTable {
    ...
    private final SudokuDigit[][] table = new SudokuDigit[9][9];
    ...
    boolean solve(int position) {
        ...
        /*
         make a shallow copy of the  possible values at x,y
        */
        ArrayList<Integer> posssibleValues = new ArrayList<>(table[x][y].getPossibleValues()); //
    ...
    // returns an int (from 0 to 81) representing the number of digits that are
    // solved in the table
    ...
    public String toString() {
        ...
        for (int y = 0; y < 9; y++) {
            for (int x = 0; x < 9; x++) {
                str.append(table[x][y].getAnswer()).append(" ");
            }
            str.append("\n");
        }
        return str.toString();
